...
#     input_variables=["draft", "tone", "dialect"], template=template)
...
# #     return OpenAI(model="gpt-4o-mini", temperature=0.7, openai_api_key=openai_api_key)
...
#                    icon="⚠️")
#         st.stop()
# pf = prompt.format(draft=draft_input, tone=option_tone, dialect=option_dialect)
